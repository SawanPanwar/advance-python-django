...
class UserCtl(BaseCtl):
    ...
    def input_validation(self, request):
        ...
        if DataValidator.is_null(self.form['role_id']) or request.form.get("roleId") == "0":
    ...
    def request_to_form(self, request):
        ...
        self.form['role_id'] = request.form.get('roleId', 0)
    ...
    def form_to_model(self, obj):
        ...
        role = RoleService().get(self.form['role_id'])
